...
def generate_and_run(contents_course_restrict,contents_faculty_restrict):
    ...
    # Moving this here as it will depend on course restrict TODO, add num_cols to 
    global num_cols
    num_cols = len(contents_course_restrict)
    if(num_cols<=10):
        num_cols=1
...
# All printing needs to be commented out when being called form a separate file
