...
<html>
  <div class="MacbookPro141" style="width: 1512px; height: 982px; position: relative; background: white">
      <div class="Rectangle2" style="width: 953px; height: 222px; left: 278px; top: 198px; position: absolute; background: #EFEDED; box-shadow: 0px 4px 18.399999618530273px rgba(0, 0, 0, 0.25)"></div>
      ...
      <div class="TodoAddABriefDescriptionAsToWhatThisSiteIsAndWhatItDoes" style="width: 909px; height: 207px; left: 301px; top: 213px; position: absolute; color: black; font-size: 36px; font-family: Inter; font-weight: 400; word-wrap: break-word">TODO: Add a brief description as to what this site is and what it does<br/>And replace this fantastic looking site for the one with color</div>
      <div class="Rectangle3" style="width: 171px; height: 56px; left: 597px; top: 810px; position: absolute; background: #D9D9D9"></div>
      <div class="Rectangle4" style="width: 171px; height: 56px; left: 841px; top: 810px; position: absolute; background: #D9D9D9"></div>
      ...
      <div class="Rectangle6" style="width: 259px; height: 56px; left: 902px; top: 475px; position: absolute; background: #D9D9D9">
        <a href="dynamic_class_csv.php">
            <button>Create new csv</button>
        </a>
      </div>
      <div class="Rectangle7" style="width: 176px; height: 56px; left: 995px; top: 657px; position: absolute; background: #D9D9D9"></div>
      <div class="Load" style="left: 1040px; top: 663px; position: absolute; color: black; font-size: 36px; font-family: Inter; font-weight: 400; word-wrap: break-word">Load</div>
